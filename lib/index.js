...
var SDK = /** @class */ (function () {
    ...
    function SDK(params) {
        ...
        var _c = options || { networkId: undefined, transactionSigner: undefined }, networkIdOpt = _c.networkId, transactionSigner = _c.transactionSigner, _d = _c.transactionFee, transactionFee = _d === void 0 ? 10 : _d;
        this.rpc = new rpc_1.Rpc({
            server: server,
            options: { transactionSigner: transactionSigner, transactionFee: transactionFee }
        });
