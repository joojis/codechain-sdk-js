...
exports.signEcdsa = function (message, priv) {
    var _a = codechain_primitives_1.signEcdsa(message, priv), r = _a.r, s = _a.s, v = _a.v;
    return "" + _.padStart(r, 64, "0") + _.padStart(s, 64, "0") + _.padStart(v.toString(16), 2, "0");
};
/**
...
exports.verifyEcdsa = function (message, signature, pub) {
    ...
    var r = signature.substr(0, 64);
    var s = signature.substr(64, 64);
    var v = Number.parseInt(signature.substr(128, 2), 16);
    return codechain_primitives_1.verifyEcdsa(message, { r: r, s: s, v: v }, pub);
};
/**
...
exports.recoverEcdsa = function (message, signature) {
    ...
    var s = signature.substr(64, 64);
    var v = Number.parseInt(signature.substr(128, 2), 16);
    return codechain_primitives_1.recoverEcdsa(message, { r: r, s: s, v: v });
};
/**
