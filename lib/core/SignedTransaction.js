...
var SignedTransaction = /** @class */ (function () {
    ...
    SignedTransaction.prototype.getSignerAccountId = function () {
        ...
        var publicKey = utils_1.recoverEcdsa(unsigned.hash().value, _signature);
    ...
    SignedTransaction.prototype.getSignerPublic = function () {
        var _a = this, _signature = _a._signature, unsigned = _a.unsigned;
        return new codechain_primitives_1.H512(utils_1.recoverEcdsa(unsigned.hash().value, _signature));
    };
    /**
    ...
    SignedTransaction.prototype.toJSON = function () {
        ...
        var result = __assign({}, unsigned.toJSON(), { blockNumber: blockNumber, blockHash: blockHash === null ? null : blockHash.toJSON(), transactionIndex: transactionIndex, sig: "0x" + _signature, hash: this.hash().toJSON() });
        return result;
    };
