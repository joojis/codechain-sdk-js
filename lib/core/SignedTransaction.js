...
var SignedTransaction = /** @class */ (function () {
     ...
     */
    function SignedTransaction(unsigned, signature, blockNumber, blockHash, transactionIndex, result) {
    ...
    SignedTransaction.prototype.toJSON = function () {
        var _a = this, blockNumber = _a.blockNumber, blockHash = _a.blockHash, transactionIndex = _a.transactionIndex, result = _a.result, unsigned = _a.unsigned, _signature = _a._signature;
        var json = __assign({}, unsigned.toJSON(), { blockNumber: blockNumber, blockHash: blockHash === null ? null : blockHash.toJSON(), transactionIndex: transactionIndex,
            result: result, sig: "0x" + _signature, hash: this.hash().toJSON() });
        return json;
    };
