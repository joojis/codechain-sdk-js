...
var Core = /** @class */ (function () {
    ...
    Core.prototype.createChangeAssetSchemeTransaction = function (params) {
        ...
        var _b = scheme.networkId, networkId = _b === void 0 ? this.networkId : _b, _c = scheme.approver, approver = _c === void 0 ? null : _c, _d = scheme.registrar, registrar = _d === void 0 ? null : _d, _e = scheme.allowedScriptHashes, allowedScriptHashes = _e === void 0 ? null : _e;
        checkMetadata(scheme.metadata);
        var metadata = typeof scheme.metadata === "string"
            ? scheme.metadata
            : JSON.stringify(scheme.metadata);
