...
var Core = /** @class */ (function () {
    ...
    Core.prototype.createAssetScheme = function (params) {
        var shardId = params.shardId, metadata = params.metadata, supply = params.supply, _a = params.approver, approver = _a === void 0 ? null : _a, _b = params.registrar, registrar = _b === void 0 ? null : _b, _c = params.allowedScriptHashes, allowedScriptHashes = _c === void 0 ? null : _c, _d = params.pool, pool = _d === void 0 ? [] : _d;
        checkShardId(shardId);
    ...
    Core.prototype.createChangeAssetSchemeTransaction = function (params) {
        ...
        var _b = scheme.networkId, networkId = _b === void 0 ? this.networkId : _b, metadata = scheme.metadata, _c = scheme.approver, approver = _c === void 0 ? null : _c, _d = scheme.registrar, registrar = _d === void 0 ? null : _d, _e = scheme.allowedScriptHashes, allowedScriptHashes = _e === void 0 ? null : _e;
        checkNetworkId(networkId);
    ...
    Core.prototype.createIncreaseAssetSupplyTransaction = function (params) {
        var shardId = params.shardId, assetType = params.assetType, recipient = params.recipient, _a = params.supply, supply = _a === void 0 ? codechain_primitives_1.U64.MAX_VALUE : _a, _b = params.approvals, approvals = _b === void 0 ? [] : _b;
