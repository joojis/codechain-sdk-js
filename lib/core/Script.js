...
var Script = /** @class */ (function () {
    ...
    Script.prototype.toTokens = function () {
        var data = this.data;
        var tokens = [];
        var _a = Script.Opcode, NOP = _a.NOP, BURN = _a.BURN, NOT = _a.NOT, EQ = _a.EQ, JMP = _a.JMP, JNZ = _a.JNZ, JZ = _a.JZ, PUSH = _a.PUSH, POP = _a.POP, PUSHB = _a.PUSHB, DUP = _a.DUP, SWAP = _a.SWAP, COPY = _a.COPY, DROP = _a.DROP, CHKSIG = _a.CHKSIG, BLAKE256 = _a.BLAKE256, SHA256 = _a.SHA256, RIPEMD160 = _a.RIPEMD160, KECCAK256 = _a.KECCAK256, BLAKE160 = _a.BLAKE160, CHKTIMELOCK = _a.CHKTIMELOCK;
        var cursor = 0;
