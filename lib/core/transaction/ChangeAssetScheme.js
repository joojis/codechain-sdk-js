...
var AssetSchemeChangeTransaction = /** @class */ (function () {
    ...
    function AssetSchemeChangeTransaction(params) {
        var networkId = params.networkId, shardId = params.shardId, assetType = params.assetType, metadata = params.metadata, approver = params.approver, registrar = params.registrar, allowedScriptHashes = params.allowedScriptHashes;
    ...
    AssetSchemeChangeTransaction.prototype.toEncodeObject = function () {
        var _a = this, networkId = _a.networkId, shardId = _a.shardId, assetType = _a.assetType, metadata = _a.metadata, approver = _a.approver, registrar = _a.registrar, allowedScriptHashes = _a.allowedScriptHashes;
        return [
            0x15,
            networkId,
            shardId,
