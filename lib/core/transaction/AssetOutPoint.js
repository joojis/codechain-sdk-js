...
var AssetOutPoint = /** @class */ (function () {
    ...
    AssetOutPoint.fromJSON = function (data) {
        ...
        return new this({
            ...
            index: index,
            assetType: new H160_1.H160(assetType),
            shardId: shardId,
            quantity: U64_1.U64.ensure(quantity),
            lockScriptHash: lockScriptHash == null ? undefined : new H160_1.H160(lockScriptHash),
            parameters: parameters == null
                ? undefined
                : parameters.map(function (p) { return Buffer.from(p); })
        });
    };
    /**
