...
var ChainRpc = /** @class */ (function () {
     ...
     */
    ChainRpc.prototype.containTransaction = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!codechain_primitives_1.H256.check(hash)) {
                            throw Error("Expected the first argument of containTransaction to be an H256 value but found " + hash);
                        }
                        return [4 /*yield*/, this.rpc.sendRpcRequest("chain_containTransaction", ["0x" + codechain_primitives_1.H256.ensure(hash).value])];
                    case 1:
                        result = _a.sent();
                        try {
                            ...
                            throw Error("Expected chain_containTransaction to return JSON of boolean, but an error occurred: " + e.toString());
                        }
                        return [2 /*return*/];
                }
            });
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        attemptToGet = function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                return [2 /*return*/, this.rpc.sendRpcRequest("mempool_getTransactionResultsByTracker", ["0x" + codechain_primitives_1.H256.ensure(tracker).value])];
                            });
                        }); };
                        startTime = Date.now();
