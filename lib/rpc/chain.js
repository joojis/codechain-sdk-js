                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            throw Error("Expected chain_getInvoice to return either null or JSON of boolean, but an error occurred: " + e.toString());
                        }
                        return [2 /*return*/];
                }
            });
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            throw Error("Expected chain_getInvoicesByTracker to return JSON of boolean[], but an error occurred: " + e.toString() + ". received: " + JSON.stringify(result));
                        }
                        return [2 /*return*/];
                }
            });
